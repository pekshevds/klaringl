    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city_from', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='cities_from', to='calculator_app.city', verbose_name='Город отправитель')),
                ('city_to', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='cities_to', to='calculator_app.city', verbose_name='Город получатель')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='rate_items', to='calculator_app.rateitem', verbose_name='Статья')),
            ],
            options={
